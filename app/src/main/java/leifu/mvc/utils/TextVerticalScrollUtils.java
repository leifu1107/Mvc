...
public class TextVerticalScrollUtils extends TextSwitcher implements ViewSwitcher.ViewFactory {
    ...
    public TextVerticalScrollUtils(Context context) {
        this(context, null);
        mContext = context;
    }

    public TextVerticalScrollUtils(Context context, AttributeSet attrs) {
        super(context, attrs);
        mContext = context;
