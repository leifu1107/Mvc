...
public abstract class BaseContentActivity extends SupportActivity {
    ...
    public LinearLayout ll_allActivity;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ll_allActivity = (LinearLayout) findViewById(R.id.ll_allActivity);
        ViewGroup view = (ViewGroup) LayoutInflater.from(this).inflate(getLayout(), null);
        ll_allActivity.addView(view);
